            ...
            <table className="table-fixed overflow-auto xl:w-full">
                <thead>
                    <tr>
                        ...
                        <th className="p-4 pb-8 text-sm font-semibold capitalize w-[200px] text-left"> Title </th>
                        <th className="p-4 pb-8 text-sm font-semibold capitalize w-[300px] text-left"> Description </th>
                        <th className="p-4 pb-8 text-sm font-semibold capitalize md:w-[150px]"> Tags </th>
                            ...
                            <tr key={item.id} className="border-b border-[#2E3443] [&>td]:align-baseline [&>td]:px-4 [&>td]:py-4">
                                ...
                                <td>
                                    <div className="flex items-center justify-center space-x-3">
                                        <button onClick={()=>{handleDelete(item.id)}} className="bg-red-700 text-white px-3 py-1">Delete</button>
                                        <button onClick={()=>{editClick(item)}} className="bg-sky-600 text-white px-3 py-1">Edit</button>
                                    </div>
                                </td>
                            </tr>
                        ))
